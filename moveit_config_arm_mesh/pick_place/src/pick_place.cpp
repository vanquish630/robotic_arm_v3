...
void openGripper(trajectory_msgs::JointTrajectory& posture)
{
  ...
  posture.joint_names[0] = "claw_L";
  posture.joint_names[1] = "claw_R";
...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  grasps[0].grasp_pose.pose.position.z = 0.01;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[0].primitive_poses[0].position.x = 0.25;
  ...
  collision_objects[1].primitive_poses[0].position.y = 0.25;
  collision_objects[1].primitive_poses[0].position.z = 0.02;
  // END_SUB_TUTORIAL
  ...
  collision_objects[2].primitive_poses[0].position.z = 0.04;
  // END_SUB_TUTORIAL
